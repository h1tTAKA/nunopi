...
export default function MemorizeView({ active = true }: { active?: boolean }) {
  ...
  if (phase === "session" && session) {
    return <CardSession active={active} sources={session.sources} mode={session.mode} onExit={() => setPhase("select")} />;
  }
