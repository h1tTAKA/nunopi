...
export function buildTextPrompt(request: AgentAnalyzeRequest): string {
  ...
  return [
    ...TEXT_HEADER,
    "",
    "Depth, but bounded (helpful to a beginner — NOT exhaustive):",
    "- Pick the MOST IMPORTANT IT/tech terms that genuinely appear — AT MOST about 12.",
    "  Do not invent terms, do not over-split, do not force-list minor passing mentions.",
    "- Each term explanation: 2-3 sentences (what it is + why it matters here + one short everyday analogy when it aids understanding). No filler/padding.",
    "- Concepts: ONLY the few background ideas MOST needed to understand those terms — AT MOST about 6. Skip anything not central.",
